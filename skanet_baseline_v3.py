...
class BaselineDecoder(nn.Module):
    # Added return_boundary flag to init
...
class BaselineDecoder(nn.Module):
    def __init__(self, num_classes=1):
        ...
        # Store intermediate features for boundary head
    ...
    def forward(self, f4, f3, f2, f1, original_size):
        ...
        # Store d2 features for boundary head (before final conv)
        self.d2_features = d1
...
class SKANetPVT_Baseline(nn.Module):
    ...
    def forward(self, x):
        ...
        # No sigmoid here - the loss function will handle it
        return output
